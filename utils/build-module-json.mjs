...
template.url = "https://github.com/toastygm/hm-loc-ko";
template.bugs = "https://github.com/toastygm/hm-loc-ko/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-ko/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-ko/releases/download/v${pkg.version}/module.zip`;
